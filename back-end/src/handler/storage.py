...
class ResourceStorage:
    """Storage backend for JSON resource rows.

    Repositories own resource behavior; storage owns SQL shape and execution.
    """
...
class PostgresResourceStorage(ResourceStorage):
    def get(self, table: str, parent: Optional[str], resource_id: int) -> Optional[Dict]:
